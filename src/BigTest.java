...
public class BigTest {
	...
	private static ArrayList<Pair<Integer, Integer>> intervals = new ArrayList<>();
	private static ArrayList<Integer> possible = new ArrayList<>();

	@BeforeClass
	public static void setup() {
		ArrayList<Pair<Integer, Integer>> active = new ArrayList<>();
